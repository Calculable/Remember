...
let historicExampleMemories: [Memory] = {
    ...
    memories.append(Memory(name: String(localized: "Steve Jobs presents the first iPhone"), date: Date(day: 9, month: 1, year: 2007), image: UIImage(named: "first_iphone"), coordinate: CLLocationCoordinate2D(latitude: 37.7843318589039, longitude: -122.40069000218438), notes: String(localized: "Steve Jobs presents the first iPhone (description)"), notificationsEnabled: false))
